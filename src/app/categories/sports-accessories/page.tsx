...
import SportsAccessoriesBrands from "./SportsAccessoriesBrands";
import SportsAccessoriesProducts from "./SportsAccessoriesProducts";
...
export default function page() {
  ...
  return (
    <div className="p-4 xl:px-[5.4rem] 2xl:px-[7.7rem] dark:bg-[#181D25]">
      <h1 className="text-4xl font-semibold mt-10">Sports Accessories</h1>
      ...
      <div className="flex lg:gap-4 md:justify-start w-full">
        ...
        <div className="md:flex-1">
          <SportsAccessoriesProducts products={sort} />
        </div>
