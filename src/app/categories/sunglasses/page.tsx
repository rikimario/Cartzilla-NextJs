...
import { getProductsSunglasses, Product } from "@/app/utils/products";
...
import SunglassesProducts from "./SunglassesProducts";
...
export default function page() {
  const products = getProductsSunglasses();
  ...
  return (
    <div className="p-4 xl:px-[5.4rem] 2xl:px-[7.7rem] dark:bg-[#181D25]">
      <h1 className="text-2xl font-semibold mt-10">Sunglasses</h1>
      ...
      <div className="flex lg:gap-4 md:justify-start w-full">
        ...
        <div className="md:flex-1">
          <SunglassesProducts products={sort} />
        </div>
