...
import { getProductsAutomotive, Product } from "@/app/utils/products";
...
import AutomotiveBrands from "./AutomotiveBrands";
import AutomotiveProducts from "./AutomotiveProducts";
...
export default function page() {
  const products = getProductsAutomotive();
    ...
    <div className="p-4 xl:px-[5.4rem] 2xl:px-[7.7rem] dark:bg-[#181D25]">
      ...
      <div className="flex lg:gap-4 md:justify-start w-full">
        ...
        <div className="md:flex-1">
          <AutomotiveProducts products={sort} />
        </div>
